...
void main()
{
    while (true)
    {
        ...
        cout << "Размер массива: " << size << endl << elapsed_ms2.count() * 0.000000001 << " (ss), "
            << elapsed_ms.count() * 0.000000001 << " (qs)" << endl;
        cout << "Введите любой символ, если вы хотите выбрать следующий размер массива" << endl
            << "Если вы хотите закрыть программу, введите q" << endl;
        cin >> skip;
        if (skip == 'q')
        {
            break;
